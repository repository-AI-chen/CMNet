...
def parse_args(argv):
    ...
    parser.add_argument(
        ...
        "--dataset",
        type=str,
        default= "/data/cry/research_work/datasets/openimage_v6",
    ...
    parser.add_argument("-o", "--only_model", type=int, default=0, help="Load only model weights")
    parser.add_argument("-savedir", "--savedir", type=str, default= file_directory_path+"/save/", help="save_dir")
    ...
    # previous_checkpoint_path = "./50000_checkpoint.pth"
...
def build_dataset(args):
    ...
    test_dataset = OpenImageDataset(test_data_root, split="data")
