...
if __name__ == "__main__":
    for task in ["segmentation", "detection"]:
        ...
        parser.add_argument(
            ...
            default=f"./inference/dataset/annotations_5k/{task}_validation_input_5k.lst",
            # default='./inference/dataset/annotations_5k/detection_validation_input_5k.lst',
            help=(
        ...
        parser.add_argument(
            ...
            type=str,
            ########################### segmentation or detection ###########################
            default=f"./inference/dataset/validation/{task}",
            # default='./inference/dataset/validation/detection',
