...
# file_directory_path = '/data2/cry/myCode/first_work/version_20240929'

# flags.DEFINE_string('input_annotations_boxes', default=file_directory_path+"/map/map_util/detection_validation_5k_bbox.csv",
#                     help='File with groundtruth boxes annotations.')
# flags.DEFINE_string('input_annotations_labels', file_directory_path+"/map/map_util/detection_validation_labels_5k.csv",
#                     'File with groundtruth labels annotations.')
# flags.DEFINE_string(
#     'input_predictions', file_directory_path+"/map/map_out/oid_oi.txt",
#     """File with detection predictions; NOTE: no postprocessing is applied in the evaluation script."""
# )
# # flags.DEFINE_string(
# #     'input_predictions', "/data1/whh/W-MSFC/save/model_no_ar_ssim_mse/det_result/0.25_0.25/best_170000_checkpoint_oi.txt",
# #     """File with detection predictions; NOTE: no postprocessing is applied in the evaluation script."""
# # )
# flags.DEFINE_string('input_class_labelmap', file_directory_path+"/map/map_util/coco_label_map.pbtxt",
#                     'Open Images Challenge labelmap.')
# flags.DEFINE_string('output_metrics', file_directory_path+"/map/map_out/map.txt", 'Output file with csv metrics.')
# flags.DEFINE_string(
...
file_directory_path = '/data/cry/research_work/first_work/segmentation/without_auto_regression/version_20241011'

flags.DEFINE_string('input_annotations_boxes', default=file_directory_path+"/map/map_util/segmentation_validation_bbox_5k.csv",
                    help='File with groundtruth boxes annotations.')
flags.DEFINE_string('input_annotations_labels', file_directory_path+"/map/map_util/segmentation_validation_labels_5k.csv",
                    'File with groundtruth labels annotations.')
flags.DEFINE_string(
    'input_predictions', file_directory_path+"/map/map_out/oid_oi.txt",
    """File with detection predictions; NOTE: no postprocessing is applied in the evaluation script."""
...
def main(unused_argv):
  ...
  flags.mark_flag_as_required('input_predictions')
  flags.mark_flag_as_required('input_class_labelmap')
  flags.mark_flag_as_required('input_annotations_segm')
  flags.mark_flag_as_required('output_metrics')
